...
- Update security patches ([#63](<REPO>/issues/63))
- Update rust crate async-nats to 0.49.1 ([#68](<REPO>/issues/68))
- Update rust crate quick-xml to 0.41.0 ([#69](<REPO>/issues/69))
- Update rust crate lapin to 4.10.0 ([#46](<REPO>/issues/46))
- Update rust crate lapin to 4.10.0

[0.2.1]: https://github.com/pvandervelde/queue-runtime/compare/0.2.0..0.2.1
